...
class OffersListTwo extends StatefulWidget {
  dynamic title;
  dynamic image;
  void Function()? onTap;
  int? index;
  ...
  OffersListTwo({this.title, this.image, this.onTap, this.index, this.Icon});

  @override
  State<OffersListTwo> createState() => _OffersListTwoState();
}

class _OffersListTwoState extends State<OffersListTwo> {
