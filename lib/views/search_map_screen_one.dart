...
class SearchMapScreenOne extends StatefulWidget {
  const SearchMapScreenOne({Key? key}) : super(key: key);

  @override
  _SearchMapScreenOneState createState() => _SearchMapScreenOneState();
}

class _SearchMapScreenOneState extends State<SearchMapScreenOne> {
