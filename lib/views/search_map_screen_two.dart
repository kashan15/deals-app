...
class SearchMapScreenTwo extends StatefulWidget {
  const SearchMapScreenTwo({Key? key}) : super(key: key);

  @override
  _SearchMapScreenTwoState createState() => _SearchMapScreenTwoState();
}

class _SearchMapScreenTwoState extends State<SearchMapScreenTwo> {
