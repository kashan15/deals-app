...
class VotingsScreen extends StatefulWidget {
  const VotingsScreen({Key? key}) : super(key: key);

  @override
  _VotingsScreenState createState() => _VotingsScreenState();
}

class _VotingsScreenState extends State<VotingsScreen> {
  @override
                              ...
                              Expanded(
                                child: SingleChildScrollView(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ListView.builder(
                                        itemCount: model.votingList.length,
                                        ...
                                        itemBuilder: (context, index) {
                                          return GestureDetector(
                                              ...
                                              child: CustomContainerCheckIns(
                                                icon: model.votingList[index]
                                                    ["icon"],
                                                image: model.votingList[index]
                                                    ["image"],
                                                title: model.votingList[index]
                                                    ["imageName"],
                                                smallText:
                                                    model.votingList[index]
                                                        ["smallText"],
                                                description:
                                                    model.votingList[index]
                                                        ["description"],
