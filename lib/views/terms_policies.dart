...
class TermsPolices extends StatefulWidget {
  const TermsPolices({Key? key}) : super(key: key);
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: TextWidget(
                                            textTitle: Constants.termsPolicies,
                                    ...
                                    SizedBox(height: 4.h),
                                    TextWidget(
                                      textTitle: Constants.termsConditions,
                                      textAlign: TextAlign.start,
                                    ...
                                    SizedBox(height: 3.h),
                                    TextWidget(
                                      textTitle: Constants.disclaimer,
                                      textAlign: TextAlign.start,
                                      color: ColorUtils.textHeadingColor,
                                      fontSize: 2.5.t,
                                      fontFamily: FontUtils.PoppinsSemibold,
                                    ...
                                    SizedBox(height: 3.h),
                                    TextWidget(
                                      textTitle: Constants.privacyPolicy,
                                      textAlign: TextAlign.start,
                                      color: ColorUtils.textHeadingColor,
                                      fontSize: 2.5.t,
                                      fontFamily: FontUtils.PoppinsSemibold,
