...
import 'package:deals_app/views/offers/saved_offers.dart';
...
class Fovourites extends StatefulWidget {
  const Fovourites({Key? key}) : super(key: key);

  @override
  _FovouritesState createState() => _FovouritesState();
}

class _FovouritesState extends State<Fovourites> {
  @override
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    TextWidget(
                                      textTitle: model.favoriteselect == 0 ? Constants.favourite: Constants.saved,
