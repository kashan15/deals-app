...
class InterestScreenOne extends StatefulWidget {
  const InterestScreenOne({Key? key}) : super(key: key);

  @override
  _InterestScreenOneState createState() => _InterestScreenOneState();
}

class _InterestScreenOneState extends State<InterestScreenOne> {
  @override
